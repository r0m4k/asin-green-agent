...
def main():
    ...
    skill = AgentSkill(
        id="asin_benchmark",
        name="ASIN Benchmark",
        description="Orchestrates ASIN navigation evaluation and produces per-task scores.",
        tags=["asin", "benchmark", "spatial_navigation"],
        examples=[],
    )

    agent_card = AgentCard(
        name="asin_green_agent",
        description="ASIN (Assessment of Spatial Intelligence for Navigation) green agent benchmark.",
